...
if(NOT glm_POPULATED)
	...
	if(USE_SHARED_LIBS)
		SetTargetProperties(glm_shared FOLDER 3rdparty/Shared)
		SetTargetProperties(glm_shared RUNTIME_OUTPUT_DIRECTORY_DEBUG "${FINAL_BIN_DIR}")
		SetTargetProperties(glm_shared RUNTIME_OUTPUT_DIRECTORY_RELEASE "${FINAL_BIN_DIR}")
		SetTargetProperties(glm_shared RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${FINAL_BIN_DIR}")
		SetTargetProperties(glm_shared RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${FINAL_BIN_DIR}")
		set(GLM_LIBRARIES glm_shared)
	else()
		SetTargetProperties(glm FOLDER 3rdparty/Static)
