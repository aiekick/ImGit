...
if(NOT curl_POPULATED)
	...
	if(USE_SHARED_LIBS)
		...
		SetTargetProperties(libcurl_shared RUNTIME_OUTPUT_DIRECTORY_DEBUG "${FINAL_BIN_DIR}")
		SetTargetProperties(libcurl_shared RUNTIME_OUTPUT_DIRECTORY_RELEASE "${FINAL_BIN_DIR}")
		SetTargetProperties(libcurl_shared RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${FINAL_BIN_DIR}")
		SetTargetProperties(libcurl_shared RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${FINAL_BIN_DIR}")
  		if (TARGET libcurl_object)
			SetTargetProperties(libcurl_shared FOLDER 3rdparty/Shared/curl)
			SetTargetProperties(libcurl_object FOLDER 3rdparty/Shared/curl)
			SetTargetProperties(libcurl_object RUNTIME_OUTPUT_DIRECTORY_DEBUG "${FINAL_BIN_DIR}")
			SetTargetProperties(libcurl_object RUNTIME_OUTPUT_DIRECTORY_RELEASE "${FINAL_BIN_DIR}")
			SetTargetProperties(libcurl_object RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${FINAL_BIN_DIR}")
			SetTargetProperties(libcurl_object RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${FINAL_BIN_DIR}")
		else()
			SetTargetProperties(libcurl_shared FOLDER 3rdparty/Shared)
  		endif()
		...
		SetTargetProperties(libcurl_static FOLDER 3rdparty/Static)
  		if (TARGET libcurl_object)
			SetTargetProperties(libcurl_object FOLDER 3rdparty/Static)
		endif()
		if (CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
