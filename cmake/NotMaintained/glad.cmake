...
if(NOT glad_POPULATED)
	...
	if (BUILD_SHARED_LIBS)
		...
		SetTargetProperties(glad POSITION_INDEPENDENT_CODE ON)
	else()
	...
	if(USE_SHARED_LIBS)
		SetTargetProperties(glad FOLDER 3rdparty/Shared)
	else()
		SetTargetProperties(glad FOLDER 3rdparty/Static)
	endif()
	
	SetTargetProperties(glad LINKER_LANGUAGE C)

	SetTargetProperties(glad RUNTIME_OUTPUT_DIRECTORY "${FINAL_BIN_DIR}")
	SetTargetProperties(glad RUNTIME_OUTPUT_DIRECTORY_DEBUG "${FINAL_BIN_DIR}")
	SetTargetProperties(glad RUNTIME_OUTPUT_DIRECTORY_RELEASE "${FINAL_BIN_DIR}")
	SetTargetProperties(glad RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${FINAL_BIN_DIR}")
	SetTargetProperties(glad RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${FINAL_BIN_DIR}")
