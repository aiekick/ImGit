...
if(NOT tinyxml2_POPULATED)
	...
	if (BUILD_SHARED_LIBS)
		...
		SetTargetProperties(tinyxml2 POSITION_INDEPENDENT_CODE ON)
		SetTargetProperties(tinyxml2 DEFINE_SYMBOL "TINYXML2_EXPORT")
	else()
	...
	if(USE_SHARED_LIBS)
		SetTargetProperties(tinyxml2 FOLDER 3rdparty/Shared)
		SetTargetProperties(tinyxml2 RUNTIME_OUTPUT_DIRECTORY_DEBUG "${FINAL_BIN_DIR}")
		SetTargetProperties(tinyxml2 RUNTIME_OUTPUT_DIRECTORY_RELEASE "${FINAL_BIN_DIR}")
		SetTargetProperties(tinyxml2 RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${FINAL_BIN_DIR}")
		SetTargetProperties(tinyxml2 RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${FINAL_BIN_DIR}")
	else()
		SetTargetProperties(tinyxml2 FOLDER 3rdparty/Static)
	endif()
