...
if(NOT libgit2_POPULATED)
	...
	if(USE_SHARED_LIBS)
		...
		set_target_properties(libgit2package PROPERTIES FOLDER 3rdparty/Shared)
		set_target_properties(http-parser PROPERTIES FOLDER 3rdparty/Shared)		
	else()
		set_target_properties(libgit2package PROPERTIES FOLDER 3rdparty/Static)
		set_target_properties(http-parser PROPERTIES FOLDER 3rdparty/Static)	
	endif()
