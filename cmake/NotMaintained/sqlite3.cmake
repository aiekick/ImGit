...
if (BUILD_SHARED_LIBS)
	...
	SetTargetProperties(sqlite3 POSITION_INDEPENDENT_CODE ON)
else()
...
if(USE_SHARED_LIBS)
	SetTargetProperties(sqlite3 FOLDER 3rdparty/Shared)
else()
	SetTargetProperties(sqlite3 FOLDER 3rdparty/Static)
endif()

SetTargetProperties(sqlite3 LINKER_LANGUAGE C)

SetTargetProperties(sqlite3 RUNTIME_OUTPUT_DIRECTORY "${FINAL_BIN_DIR}")
SetTargetProperties(sqlite3 RUNTIME_OUTPUT_DIRECTORY_DEBUG "${FINAL_BIN_DIR}")
SetTargetProperties(sqlite3 RUNTIME_OUTPUT_DIRECTORY_RELEASE "${FINAL_BIN_DIR}")
SetTargetProperties(sqlite3 RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${FINAL_BIN_DIR}")
SetTargetProperties(sqlite3 RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${FINAL_BIN_DIR}")
