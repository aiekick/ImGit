...
if(NOT fmt_POPULATED)
	...
	if (BUILD_SHARED_LIBS)
		SetTargetProperties(fmt POSITION_INDEPENDENT_CODE ON)
	endif()

	if(USE_SHARED_LIBS)
		SetTargetProperties(fmt FOLDER 3rdparty/Shared)
		SetTargetProperties(fmt RUNTIME_OUTPUT_DIRECTORY_DEBUG "${FINAL_BIN_DIR}")
		SetTargetProperties(fmt RUNTIME_OUTPUT_DIRECTORY_RELEASE "${FINAL_BIN_DIR}")
		SetTargetProperties(fmt RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${FINAL_BIN_DIR}")
		SetTargetProperties(fmt RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${FINAL_BIN_DIR}")
	else()
		SetTargetProperties(fmt FOLDER 3rdparty/Static)
	endif()
